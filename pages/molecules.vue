  ...
  <vf-m-container class="mx-auto mb-8">
    ...
    <div class="text-center my-8">
      <vf-m-input-group>
        ...
        <template #append>
          <vf-m-dropdown v-for="i in 2" :key="i" text="Dropdown" variant="outline-secondary">
      ...
      <vf-m-card>
        <vf-m-card-body>
          <vf-m-media>
            ...
            <vf-a-heading level="5" class="mt-0">
              Media Title
            </vf-a-heading>
            <p>
            ...
            <vf-m-media>
              <template #aside>
                <vf-a-image blank-color="#ccc" width="64" heigth="64px" alt="placeholder" />
              </template>
