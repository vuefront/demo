<template>
  <vf-m-container class="mx-auto mb-8">
    ...
    <div class="text-center my-8">
      <vf-a-button v-for="(value, index) in colors" :key="index" :color="index">{{index}}</vf-a-button>
    </div>
     <div class="text-center my-8">
    ...
    <div class="text-center my-8">
      <vf-a-button v-for="(value, index) in colors" :key="index" :color="index" rounded>{{index}}</vf-a-button>
    </div>
    <div class="text-center my-8">
    ...
    <div class="text-center my-8">
      <vf-a-button v-for="(value, index) in colors" :key="index" :color="index" rounded outline>{{index}}</vf-a-button>
    </div>
    <div class="text-center my-8">
    ...
    <div class="text-center my-8">
      <vf-a-alert v-for="(value, index) in colors" :key="index" :color="index" :show="true" dismissible>{{index}}</vf-a-alert>
    </div>
    <vf-a-heading class="text-center mt-4">BADGE</vf-a-heading>
     <div class="text-center my-8">
      <vf-a-badge v-for="(value, index) in colors" :key="index" :color="index">{{index}}</vf-a-badge>
    </div>
         <div class="text-center my-8">
      <vf-a-badge v-for="(value, index) in colors" :key="index" :color="index" rounded>{{index}}</vf-a-badge>
    </div>
